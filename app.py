...
DEFAULT_KEYWORDS = '基隆 火災, 汐止 火災, 汐止 火災, 瑞芳 火災, 新北萬里 火災, 金山 火災, 貢寮 火災, 雙溪 火災, 平溪 火災, 基隆 撞斷電, 汐止 撞斷電, 汐止 撞斷電, 瑞芳 撞斷電, 新北萬里 撞斷電, 金山 撞斷電, 貢寮 撞斷電, 雙溪 撞斷電, 平溪 撞斷電, 基隆 台電, 汐止 台電, 汐止 水電, 瑞芳 台電, 新北萬里 台電, 金山 台電, 貢寮 台電, 雙溪 台電, 平溪 台電, 基隆區處, 停電 基隆, 停電 汐止, 跳電 基隆, 跳電 汐止, 基隆區營業處, 四接工程, 協和電廠, 深澳電廠, 核一廠, 核二廠, 核四廠, 汐止一次變電所, 基隆一次變電所'
SEARCH_HOURS = 11
...
2. 若新聞涉及負面輿情、公益活動或需關注事件（如：竊電、無預警停電、跳電、民眾陳情、工安事故、挖斷電纜，房屋倒塌等），請提供 25 字以內的實務處置建議（例如：盡速派員現勘確認、預先釐清原因等）。
